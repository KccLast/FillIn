...
<%--    <!-- SweetAlert2 -->--%>
<%--    &lt;%&ndash;<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/limonte-sweetalert2/7.2.0/sweetalert2.min.css">&ndash;%&gt;--%>
<%--    &lt;%&ndash;<script src="https://cdnjs.cloudflare.com/ajax/libs/limonte-sweetalert2/7.2.0/sweetalert2.all.min.js"></script>&ndash;%&gt;--%>
...
<div class="modal fade" id="makeAutoQuestion-modal" tabindex="-1"
    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg">
        <div class="modal-content auto-modal-content">
            <%@ include file="/resources/common/loading.jsp" %>
            <%-- 첫 번째 모달 content	--%>
            <div class="modal-header first-content">
                <h5 class="modal-title" id="makeAutoQuestionModalLabel">AI 질문 생성</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>

            <div class="modal-body first-content">
                <div class="header-container d-flex justify-content-between align-items-center">
                    <p class="body-title fs-6 fw-bold">맞춤형 질문 생성</p>
                ...
                <div class="select-question-type justify-content-between">
                    ...
                    <div class="select-question-selection flex-grow-1">
                        <div class="d-flex justify-content-between align-items-center ">
                            ...
                            <button type="button" class="btn btn-secondary mb-3" id="create-auto-question-btn"
                                    onclick="showQuestionsModal()">질문 자동 생성
                            </button>
                        </div>
                        <div class="checkbox-group d-flex flex-row justify-content-between my-2" id="checkbox-group">
                        </div>
                    </div>
                    <!-- 질문 유형 선택 체크박스 end -->
                    <!-- 추가된 질문 리스트 확인 -->
                    <%--                    <div class="select-add-questions flex-grow-1">--%>
                    <%--                        <p class="fw-bold" style="display: none;">추가된 질문 목록</p>--%>
                    <%--                    </div>--%>
                </div>
            </div>
<%--            <div class="modal-footer first-content">--%>
<%--                &lt;%&ndash;                <button type="button" class="btn btn-secondary" id="create-auto-question-btn"&ndash;%&gt;--%>
<%--                &lt;%&ndash;                        onclick="showQuestionsModal()">질문 자동 생성&ndash;%&gt;--%>
<%--                &lt;%&ndash;                </button>&ndash;%&gt;--%>
<%--                <button type="button" class="btn btn-secondary" id="create-question-btn">--%>
<%--                    새 설문지 생성--%>
<%--                </button>--%>
<%--            </div>--%>
            <%-- 첫 번째 모달 content end --%>
            ...
            <div class="modal-body second-content" style="display: none;">
                ...
                <div id="multiple-choice-section" class="question-group">
                    <div class="d-flex align-items-center j-quancolor">
                        <img src="/resources/img/question/type/type7.png" alt="type7">
                        <div class="question-type">객관식 질문</div>
                    </div>
                ...
                <div id="checkbox-section" class="question-group">
                    <div class="d-flex align-items-center j-quancolor">
                        <img src="/resources/img/question/type/type8.png" alt="type8">
                        <div class="question-type">체크박스 질문</div>
                    </div>
                    <div id="checkbox-list" class="question-list"></div>
                </div>
                <!-- 단답형 질문 섹션 -->
                <div id="short-answer-section" class="question-group">
                    <div class="d-flex align-items-center j-qualcolor">
                        <img src="/resources/img/question/type/type12.png" alt="type11">
                        <div class="question-type">단답형 질문</div>
                    </div>
                ...
                <div id="long-answer-section" class="question-group">
                    <div class="d-flex align-items-center j-qualcolor">
                        <img src="/resources/img/question/type/type13.png" alt="type12">
                        <div class="question-type">장문형 질문</div>
                    </div>
            ...
            <div class="modal-footer second-content" style="display: none;">
                ...
                <button type="button" class="btn btn-secondary" id="question-close-btn">취소</button>
            </div>
            <%-- 두 번째 모달 content end --%>
        </div>
    </div>
