                                ...
                                <div class="container card">
                                        ...
                                        <div class="accordion-item">
                                            ...
                                            <div id="collapseOne" class="accordion-collapse collapse"
                                                ...
                                                <div class="accordion-body">
                                                    <strong>‘K-평균 군집화’</strong>는 AI 주관식 응답 분석을 통해 유사도를 기반으로 한 응답들을 산점도
                                                    그래프로
                                                    보여줘요.
                                                    별도의 분류 기준 없이, <strong>유사도</strong>를 기반으로 응답을 n개의 묶음으로 분류해주는 기능이에요.
                                                    각 군집은 유사한 답변을 포함하고, 이 군집들은 <strong>산점도 그래프</strong>를 통해 시각적으로 확인할 수
                                                    있어요.
                                                    이를 통해서 응답이 어떻게 분류되는지,
                                                    유사한 응답들이 어떻게
                                    ...
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <div class="mt-4 col-2">
                                            ...
                                            <div class="row">
                                                <div class="col"><input type="range" class="form-range" min="2" max="20"
