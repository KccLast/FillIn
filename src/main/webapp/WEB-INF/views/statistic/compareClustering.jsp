            ...
            <div class="accordion-item">
                ...
                <div id="collapseOne" class="accordion-collapse collapse"
                    ...
                    <div class="accordion-body">
                        <strong>군집 별 비교 분석</strong> 페이지는 앞선 K-평균 군집화와 키워드 분석 결과를 바탕으로 각 군집이 전체 설문에서 어떻게 응답했는지 자세히 보여주는
                        페이지입니다. 각 군집의 특성을 도출하고, 질문별 응답 패턴을 비교함으로써 군집마다 나타나는 고유한 특성과 경향을 이해할 수 있습니다.
                        <br><br>
                        이를 통해 사용자는 특정 군집이 설문 질문에 대해 가지는 공통된 인식과 차이점을 쉽게 파악할 수 있으며, 다른 질문들에 대한 응답 경향을 분석하여 각 군집의 반응을
                        종합적으로 이해할 수 있습니다.
                    </div>
                </div>
            </div>
