...
<head>
    ...
    <!-- jQuery UI 라이브러리 -->
    <link rel="stylesheet" href="https://code.jquery.com/ui/1.13.2/themes/base/jquery-u
    <%-- sweetAlert2 라이브러리   --%>
...
<div class="content">
    <div class="container card">
        <p class="fs-4 fw-bold mt-2 question-name"></p>
        <%-- 설명 아코디언 버튼 --%>
        <div class="accordion my-4" id="accordionRegression">
            <div class="accordion-item">
                ...
                <div id="collapseOne" class="accordion-collapse collapse" data-bs-parent="#accordionRegression">
                    <div class="accordion-body">
                        <strong>회귀분석</strong>은 '한 가지 요소'가 '다른 요소'에 어떤 영향을 미치는지,
                        그리고 그 관계가 얼마나 강한지를 이해하고 예측하는 방법입니다. <br>
                        예를 들면 <strong>부모의 키</strong>와 <strong>자녀의 키</strong> 사이에 관계가 있는지, 또 얼마나 연관이 있는지를 알아보고 싶다면 회귀분석을
                        사용할 수 있습니다.
                        ...
                        이처럼 <strong>하나의 변수(독립 변수)</strong>가 <strong>다른 변수(종속 변수)</strong>에 미치는 영향을 수학적으로 계산하여 관계를 예측하는 데
                        회귀분석이 활용됩니다.
                    </div>
                </div>
            </div>
            ...
            <div class="card-body">
                <div class="d-flex align-items-center">
                    <div class="w-100">
                        ...
                        <div class="question-list row justify-content-between" data-seq="${surveySeq}">
                            <div class="col-5 justify-content-center align-items-center flex-grow-1">
