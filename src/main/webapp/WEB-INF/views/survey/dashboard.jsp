                        ...
                        <div class="card each-survey-card d-flex flex-column">
                            <div class="card-body py-1">
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    <p class="mt-3 fw-bold">${survey.name}</p>
                                    <c:forEach var="status" items="${progressStatus}">
                                        <c:if test="${survey.ccSeq == status.seq}">
										<span class="badge rounded-pill  px-2 py-1.7 fs-6
											<c:choose>
                                ...
                                <div class="date-info">
                                    ...
                                    <p>
                                        <c:choose>
                                            <c:when test="${survey.postDate != null && survey.endDate != null}">
                                                ${survey.postDate} ~ ${survey.endDate}
                                            </c:when>
                                            <c:otherwise>
                                                설문 예정입니다.
                                            </c:otherwise>
