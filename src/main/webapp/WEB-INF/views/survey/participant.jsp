  ...
  <body>
    ...
    <div class="content">
      ...
      <div class="j-question-card j-flex-col-center">
        <input type="hidden" name="order" class="j-q-order">
        <div class="j-survey-es-type j-flex-row-center">
          <button class="j-essential" data-essential="N">필수</button>
          <!-- header 들어갈 자리  -->
        </div>
        <div class="j-survey-name">
          <div class="j-survey-input">
            설문 제목 들어가는 자리
          </div>
        </div>
        ...
        <div class="j-question-content-box">
          ...
          <div class="j-address j-flex-row-center">
            <div class="col-sm-10 j-address-box">
              ...
              <input type="text" class="form-control mb-2 zipp_code_id" id="zipp_code_id" name="zipp_code"
                maxlength="10" placeholder="우편번호" style="width: 50%; display: inline;">
              <input type="button" id="zipp_btn" class="btn btn-primary" onclick="execDaumPostcode(this)"
                value="우편번호 찾기"><br>
              <input type="text" class="form-control mb-2 UserAdd1" name="user_add1" id="UserAdd1" maxlength="40"
                placeholder="기본 주소를 입력하세요" required>
              <div class="invalid-feedback">
                주소를 입력해주시기 바랍니다!
              </div>
              <input type="text" class="form-control UserAdd2" name="user_add2" id="UserAdd2" maxlength="40"
