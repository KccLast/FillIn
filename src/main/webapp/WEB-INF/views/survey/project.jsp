...
<div id="j-question-nav">
    ...
    <div class="j-nav-button-box j-flex-row-center">
        ...
        <button type="button" id="postButton" class="btn btn-primary j-nav-input-button j-depoly-button fs-6 fw-bold"
                data-bs-toggle="modal" data-bs-target="#postModal" style="display: none;">게시
        </button>

        <!-- 공유 버튼 -->
        <button type="button" id="shareButton" class="btn btn-primary j-nav-input-button j-share-button fs-6 fw-bold"
                data-bs-toggle="modal" data-bs-target="#shareModal" style="display: none;">공유
        </button>
