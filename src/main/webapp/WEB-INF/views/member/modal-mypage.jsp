            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    <label for="address">주소</label> <input type="text" id="postalCode"
                                                           name="postalCode" class="form-control address-input"
                                                           disabled>
            ...
            <div class="modal-footer">
                <div>
                    <button type="button" id="updateMemberInfoBtn" class="btn btn-primary updateBtn"
                            ...
                            data-bs-dismiss="modal">회원 정보 수정
                    </button>
                </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="update-username" name="username" class="form-control" autocomplete="username"
                           disabled>
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="update-birth" name="birth" class="form-control" autocomplete="birth"
                           disabled>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="postalCode-group">
                        ...
                        <button class="btn btn-primary" id="postalCodeSearchBtn" type="button"
            ...
            <div class="modal-footer">
                <button class="btn btn-primary" data-bs-target="#mypage-modal" id="saveBtn"
                        data-bs-toggle="modal">저장
                </button>
                <button class="btn btn-secondary text-dark logoutBtn" data-bs-target="#mypage-modal"
                        data-bs-toggle="modal">취소
                </button>
            </div>
        </div>
    </div>
