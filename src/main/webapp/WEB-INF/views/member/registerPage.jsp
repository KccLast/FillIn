...
<div id="signup-container">
            ...
            <div class="form-step active">
                ...
                <div class="form-group">
                    ...
                    <input type="password" id="password" name="password" placeholder="비밀번호를 입력해주세요 (8~20자)"
                           class="form-control mt-3" required aria-describedby="passwordHelpBlock" style="
    font-family: arial;">
    ...
    font-family: arial;">
            ...
            <div class="form-step">
                ...
                <div class="form-group">
                    <label for="birth-year">생년월일<span style="color: red;">*</span></label>
                    ...
                    <span class="error-message" id="birth-error">생년월일을 선택해주세요<span style="color: red;">*</span></span>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <!-- 에러 메시지 위치 변경 -->
                    <div class="error-message" id="address-error" style="display: none; color: red;">주소를 모두 입력해주세요.
                    </div>
                </div>
