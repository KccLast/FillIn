            ...
            <header class="p-2">
                <div class="container-fluid">
                    <ul class="header-list d-flex justify-content-between m-1 align-items-center">
                        ...
                        <div style="width: 68%; display: flex; align-items: center; justify-content: center;">
...
<%--                            </li>--%>
                            ...
                            <li class="px-2">
                                <!-- 모달 연결 -->
                                <img class="profile" alt="profile" src="/resources/img/common/profile.png" width="35"
                                    height="35" data-bs-toggle="modal" data-bs-target="#mypage-modal">
                            </li>
                        </div>
                    </ul>
                </div>
